...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("jira_issue_type", sa.String(50), nullable=True, server_default="'Bug'",
    ...
    op.create_table(
        ...
        sa.Column("incident_type",
                  postgresql.ENUM("incident", "feedback", "question", "suggestion",
                                  ...
                                  create_type=False),
                  nullable=False, server_default="'incident'",
        ...
        sa.Column("attachments", postgresql.JSONB(), nullable=True, server_default="'[]'::jsonb",
        ...
        sa.Column("meta_data", postgresql.JSONB(), nullable=True, server_default="'{}'::jsonb"),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False,
                  server_default=sa.text("NOW()")),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False,
                  server_default=sa.text("NOW()")),
    ...
    op.create_table(
        ...
        sa.Column("category_mapping", postgresql.JSONB(), nullable=True, server_default="'{}'::jsonb",
                  comment="Mapping: category_code -> Jira issue type"),
        sa.Column("module_mapping", postgresql.JSONB(), nullable=True, server_default="'{}'::jsonb",
                  comment="Mapping: module_code -> Jira component"),
        sa.Column("priority_mapping", postgresql.JSONB(), nullable=True, server_default="'{}'::jsonb",
                  comment="Mapping: priority -> Jira priority"),
        sa.Column("custom_fields", postgresql.JSONB(), nullable=True, server_default="'{}'::jsonb",
    ...
    op.create_table(
        ...
        sa.Column("current_step", sa.String(50), nullable=False, server_default="'description'",
                  comment="Current step: description, priority, confirmation"),
        sa.Column("collected_data", postgresql.JSONB(), nullable=False, server_default="'{}'::jsonb",
