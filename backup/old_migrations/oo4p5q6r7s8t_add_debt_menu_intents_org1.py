"""Add debt_menu intents to Organization 1.

Revision ID: oo4p5q6r7s8t
Revises: nn3o4p5q6r7s
Create Date: 2026-01-12

Adds the 4 debt menu intents to Test Pharmacy (Org 1) that were only
seeded for System Org in migration 34f3a657ec4e.
...
revision: str = "oo4p5q6r7s8t"
down_revision: Union[str, Sequence[str], None] = "nn3o4p5q6r7s"
...
# Debt menu intents - copied from 34f3a657ec4e to ensure consistency
DEBT_MENU_INTENTS = {
    "debt_menu_pay_total": {
...
def upgrade() -> None:
    """Add debt menu intents to Organization 1."""
...
def downgrade() -> None:
    """Remove debt menu intents from Organization 1."""
    connection = op.get_bind()

    for intent_key in DEBT_MENU_INTENTS:
        connection.execute(
            sa.text("""
