...
def upgrade() -> None:
    """Upgrade schema."""
    # Create schemas before any table operations
    # Required for fresh databases where schemas don't exist
    # These are idempotent - safe to run multiple times
    op.execute("CREATE SCHEMA IF NOT EXISTS core")
    op.execute("CREATE SCHEMA IF NOT EXISTS ecommerce")
    op.execute("CREATE SCHEMA IF NOT EXISTS healthcare")
    ...
    op.create_table(
        ...
        sa.Column(
            "category", sa.String(length=200), nullable=True, comment="Secondary category for finer classification"
        ),
        sa.Column(
            "tags",
    ...
    op.create_index(
        "idx_knowledge_tags", "company_knowledge", ["tags"], unique=False, schema="core", postgresql_using="gin"
    )
    op.create_index(
        "idx_knowledge_type_active", "company_knowledge", ["document_type", "active"], unique=False, schema="core"
    )
    op.create_index(
        op.f("ix_core_company_knowledge_active"), "company_knowledge", ["active"], unique=False, schema="core"
    )
    op.create_index(
        op.f("ix_core_company_knowledge_category"), "company_knowledge", ["category"], unique=False, schema="core"
    )
    op.create_index(
        op.f("ix_core_company_knowledge_document_type"),
        "company_knowledge",
        ["document_type"],
        unique=False,
        schema="core",
    ...
    op.create_table(
        ...
        sa.Column(
            "slug", sa.String(length=50), nullable=False, comment="URL-friendly unique identifier (e.g., 'acme-corp')"
        ),
        sa.Column("name", sa.String(length=255), nullable=False, comment="Official organization name"),
        sa.Column(
            "display_name", sa.String(length=255), nullable=True, comment="Display name for UI (falls back to name)"
        ),
        sa.Column(
            "mode",
            sa.String(length=20),
        ...
        sa.Column(
            "trial_ends_at", sa.DateTime(), nullable=True, comment="Trial expiration date (null if not on trial)"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_credit_credit_accounts_account_number"),
        "credit_accounts",
        ["account_number"],
        unique=True,
        schema="credit",
    ...
    op.create_index(
        op.f("ix_credit_credit_accounts_customer_id"), "credit_accounts", ["customer_id"], unique=False, schema="credit"
    )
    op.create_index(op.f("ix_credit_credit_accounts_id"), "credit_accounts", ["id"], unique=False, schema="credit")
    op.create_index(
        op.f("ix_credit_credit_accounts_status"), "credit_accounts", ["status"], unique=False, schema="credit"
    )
    op.create_table(
        "analytics",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ecommerce_analytics_metric_name"), "analytics", ["metric_name"], unique=False, schema="ecommerce"
    )
    op.create_table(
        "brands",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ecommerce_categories_external_id"), "categories", ["external_id"], unique=False, schema="ecommerce"
    )
    op.create_table(
        "customers",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ecommerce_customers_phone_number"), "customers", ["phone_number"], unique=True, schema="ecommerce"
    )
    op.create_table(
        "promotions",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ecommerce_promotions_promo_code"), "promotions", ["promo_code"], unique=True, schema="ecommerce"
    )
    op.create_table(
        "doctors",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_healthcare_doctors_license_number"), "doctors", ["license_number"], unique=True, schema="healthcare"
    )
    op.create_table(
        "patients",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "status", sa.Enum("ACTIVE", "INACTIVE", "DECEASED", "TRANSFERRED", name="patientstatus"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_healthcare_patients_medical_record_number"),
        "patients",
    ...
    op.create_index(
        op.f("ix_healthcare_patients_national_id"), "patients", ["national_id"], unique=True, schema="healthcare"
    )
    ...
    op.create_index(
        op.f("ix_core_organization_users_organization_id"),
        "organization_users",
        ["organization_id"],
        unique=False,
        schema="core",
    ...
    op.create_index(
        op.f("ix_core_organization_users_user_id"), "organization_users", ["user_id"], unique=False, schema="core"
    )
    op.create_table(
        "tenant_agents",
        ...
        sa.Column(
            "agent_type", sa.String(length=50), nullable=False, comment="Agent type: 'domain', 'specialized', 'custom'"
        ),
        ...
        sa.Column(
            "domain_key", sa.String(length=50), nullable=True, comment="Associated domain key (for domain agents)"
        ),
        sa.Column(
            "keywords", postgresql.ARRAY(sa.String()), nullable=False, comment="Keywords that trigger this agent"
        ),
        sa.Column(
            "intent_patterns",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_index(
        op.f("ix_core_tenant_agents_domain_key"), "tenant_agents", ["domain_key"], unique=False, schema="core"
    )
    op.create_index(op.f("ix_core_tenant_agents_enabled"), "tenant_agents", ["enabled"], unique=False, schema="core")
    op.create_index(
        op.f("ix_core_tenant_agents_organization_id"), "tenant_agents", ["organization_id"], unique=False, schema="core"
    )
    op.create_table(
        "tenant_configs",
        ...
        sa.Column(
            "agent_timeout_seconds", sa.Integer(), nullable=False, comment="Timeout for agent operations in seconds"
        ),
    ...
    op.create_index(
        "idx_tenant_docs_org_active", "tenant_documents", ["organization_id", "active"], unique=False, schema="core"
    )
    op.create_index("idx_tenant_docs_org_id", "tenant_documents", ["organization_id"], unique=False, schema="core")
    op.create_index(
        "idx_tenant_docs_org_type",
        "tenant_documents",
    ...
    op.create_index(
        "idx_tenant_docs_tags", "tenant_documents", ["tags"], unique=False, schema="core", postgresql_using="gin"
    )
    op.create_index(
        op.f("ix_core_tenant_documents_active"), "tenant_documents", ["active"], unique=False, schema="core"
    )
    op.create_index(
        op.f("ix_core_tenant_documents_category"), "tenant_documents", ["category"], unique=False, schema="core"
    )
    op.create_index(
        op.f("ix_core_tenant_documents_document_type"),
        "tenant_documents",
        ["document_type"],
        unique=False,
        schema="core",
    ...
    op.create_index(
        op.f("ix_core_tenant_documents_organization_id"),
        "tenant_documents",
        ["organization_id"],
        unique=False,
        schema="core",
    ...
    op.create_table(
        ...
        sa.Column(
            "template", sa.Text(), nullable=False, comment="The prompt template text with {variable} placeholders"
        ),
    ...
    op.create_index(
        "idx_tenant_prompts_org_key_scope",
        "tenant_prompts",
        ["organization_id", "prompt_key", "scope"],
        unique=False,
        schema="core",
    )
    ...
    op.create_index(
        op.f("ix_core_tenant_prompts_is_active"), "tenant_prompts", ["is_active"], unique=False, schema="core"
    )
    op.create_index(
        op.f("ix_core_tenant_prompts_organization_id"),
        "tenant_prompts",
        ["organization_id"],
        unique=False,
        schema="core",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["account_id"],
            ["credit.credit_accounts.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="credit",
    )
    op.create_index(
        op.f("ix_credit_payment_schedule_items_account_id"),
        "payment_schedule_items",
        ["account_id"],
        unique=False,
        schema="credit",
    ...
    op.create_index(
        op.f("ix_credit_payment_schedule_items_due_date"),
        "payment_schedule_items",
        ["due_date"],
        unique=False,
        schema="credit",
    ...
    op.create_index(
        op.f("ix_credit_payment_schedule_items_id"), "payment_schedule_items", ["id"], unique=False, schema="credit"
    )
    op.create_table(
        "payments",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "payment_type",
            sa.Enum("REGULAR", "MINIMUM", "FULL", "EXTRA", "EARLY", "LATE", name="paymenttype"),
            nullable=False,
        ),
        sa.Column(
            "payment_method",
            sa.Enum(
                "BANK_TRANSFER", "DEBIT_CARD", "CREDIT_CARD", "CASH", "CHECK", "DIRECT_DEBIT", name="paymentmethod"
            ),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("PENDING", "PROCESSING", "COMPLETED", "FAILED", "REFUNDED", "CANCELLED", name="paymentstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_credit_payments_reference_number"), "payments", ["reference_number"], unique=True, schema="credit"
    )
    ...
    op.create_index(
        op.f("ix_ecommerce_conversations_session_id"), "conversations", ["session_id"], unique=False, schema="ecommerce"
    )
    op.create_table(
        "orders",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ecommerce_orders_order_number"), "orders", ["order_number"], unique=True, schema="ecommerce"
    )
    op.create_table(
        "subcategories",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "triage_priority",
            sa.Enum("RESUSCITATION", "EMERGENT", "URGENT", "LESS_URGENT", "NON_URGENT", name="triagepriority"),
            nullable=True,
        ),
        sa.Column(
            "status",
    ...
    op.create_index(
        op.f("ix_healthcare_appointments_appointment_date"),
        "appointments",
        ["appointment_date"],
        unique=False,
        schema="healthcare",
    ...
    op.create_index(
        op.f("ix_healthcare_appointments_doctor_id"), "appointments", ["doctor_id"], unique=False, schema="healthcare"
    )
    op.create_index(op.f("ix_healthcare_appointments_id"), "appointments", ["id"], unique=False, schema="healthcare")
    op.create_index(
        op.f("ix_healthcare_appointments_patient_id"), "appointments", ["patient_id"], unique=False, schema="healthcare"
    )
    op.create_index(
        op.f("ix_healthcare_appointments_status"), "appointments", ["status"], unique=False, schema="healthcare"
    )
    op.create_table(
        "prompt_versions",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["conversation_id"],
            ["ecommerce.conversations.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="ecommerce",
    )
    op.create_index(
        op.f("ix_ecommerce_messages_user_phone"), "messages", ["user_phone"], unique=False, schema="ecommerce"
    )
    op.create_index(
        op.f("ix_ecommerce_messages_whatsapp_message_id"),
        "messages",
        ["whatsapp_message_id"],
        unique=True,
        schema="ecommerce",
    ...
    op.create_index(
        "idx_products_search", "products", ["search_vector"], unique=False, schema="ecommerce", postgresql_using="gin"
    )
    ...
    op.create_index(
        "idx_product_attributes_product", "product_attributes", ["product_id"], unique=False, schema="ecommerce"
    )
    op.create_index(
        "idx_product_attributes_searchable", "product_attributes", ["is_searchable"], unique=False, schema="ecommerce"
    )
    op.create_table(
        "product_images",
        sa.Column("id", sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_credit_payment_schedule_items_due_date"), table_name="payment_schedule_items", schema="credit"
    )
    op.drop_index(
        op.f("ix_credit_payment_schedule_items_account_id"), table_name="payment_schedule_items", schema="credit"
    )
