"""Seed domain intents for organization 1.

Revision ID: ee4f5g6h7i8j
Revises: aac255afc73b
Create Date: 2026-01-11

Seeds the pharmacy domain intent patterns for organization
00000000-0000-0000-0000-000000000001 (Org 1).

This migration uses the seed data from app/scripts/seed_domain_intents.py
to populate core.domain_intents table with all pharmacy intent patterns.
"""
...
revision: str = "ee4f5g6h7i8j"
down_revision: Union[str, Sequence[str], None] = "gg6h7i8j9k0l"
...
def upgrade() -> None:
    """Seed domain intents for organization 1 pharmacy domain."""
...
def downgrade() -> None:
    """Remove domain intents for organization 1."""
    op.execute(f"""
