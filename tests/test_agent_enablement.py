...
class TestAgentFactory:
    ...
    def test_factory_creates_only_enabled_agents(self):
        ...
        factory = AgentFactory(ollama=mock_ollama, chroma=mock_chroma, postgres=mock_postgres, config=config)
...
class TestAynuxGraphAgentManagement:
    ...
    def mock_graph(self):
        ...
        with patch("app.agents.graph.OllamaIntegration"), patch("app.agents.graph.ChromaDBIntegration"), patch(
