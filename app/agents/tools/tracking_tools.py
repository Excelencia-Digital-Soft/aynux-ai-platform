...
ORDERS_DB = {
    "ORD-2024-001": {
        ...
        "items": [{"product_id": "laptop_001", "name": "Laptop Gaming ASUS ROG", "quantity": 1}],
    ...
    "ORD-2024-003": {
        ...
        "carrier": "Express Delivery",
        "items": [{"product_id": "laptop_003", "name": "Laptop HP Pavilion", "quantity": 1}],
...
async def get_delivery_info_tool(order_id: str, detailed: bool = False) -> Dict[str, Any]:
    ...
    if detailed:
        ...
        delivery_options = [
            ...
            {"option": "Entrega sin contacto", "description": "Dejar en la puerta", "cost": 0, "available": True},
        ]
...
async def update_shipping_address_tool(
    order_id: str, new_address: str, city: str, postal_code: str, phone: Optional[str] = None
) -> Dict[str, Any]:
    """
    ...
    if len(new_address.strip()) < 10:
        return {"success": False, "error": "La dirección debe tener al menos 10 caracteres", "new_address": new_address}
