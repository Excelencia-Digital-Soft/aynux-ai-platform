...
class OllamaIntegration:
    ...
    def __init__(self, config: dict = None, base_url: str = None, model_name: str = None):
        ...
        if config and isinstance(config, dict):
            ...
            self.model_name = config.get("model") or self.settings.OLLAMA_API_MODEL
            self.embedding_model = config.get("embedding_model") or self.settings.OLLAMA_API_MODEL_EMBEDDING
        else:
