...
class SecurityManager:
    ...
    def _setup_rbac(self):
        ...
        self.roles = {
            ...
            "operator": {
                "permissions": ["agents.use", "monitoring.view", "conversations.view_own", "conversations.manage_own"],
                "description": "Operador del sistema de agentes",
            },
            "viewer": {
                "permissions": ["monitoring.view", "conversations.view_own"],
                "description": "Solo lectura de datos propios",
            },
            "customer": {
                "permissions": ["agents.use_basic", "conversations.create", "conversations.view_own"],
    ...
    def _load_security_policies(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "data_protection": {"encrypt_sensitive_data": True, "log_access": True, "audit_changes": True},
        }

    def generate_token(
        self, user_id: str, role: str, token_type: str = "access", custom_claims: Dict[str, Any] = None
    ) -> str:
        """
    ...
    def create_secure_session(self, user_id: str, role: str, session_data: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            session_info.update({"access_token": access_token, "refresh_token": refresh_token})
    ...
    def audit_log(self, user_id: str, action: str, resource: str, details: Dict[str, Any] = None, success: bool = True):
        ...
        try:
            ...
            logger.info("security_audit", extra={"audit": True, **audit_entry})

        except Exception as e:
            logger.error(f"Error logging audit entry: {e}")

    def check_rate_limit(self, user_id: str, action: str = "general") -> Tuple[bool, Dict[str, Any]]:
        """
