...
class SupportAgent(BaseAgent):
    ...
    async def _handle_warranty_inquiry(
        self, 
        message: str,
        state: SharedState
    ) -> Dict[str, Any]:
        ...
        if order_numbers:
            ...
            for order_num in order_numbers:
                ...
                if eligibility['eligible']:
                    ...
                    response += f"   • Condición requerida: Producto sin uso\n\n"
                else:
    ...
    async def _handle_technical_help(
        self, 
        message: str,
        entities: Dict
    ) -> Dict[str, Any]:
    ...
    async def _handle_general_support(
        ...
        return {
            ...
            "tools_used": ["FAQSearchTool"]
        }
    
    async def _prepare_support_ticket(
        self, 
        issue: str,
        state: SharedState
    ) -> Dict[str, Any]:
    ...
    async def _check_return_eligibility(self, order_number: str) -> Dict[str, Any]:
        ...
        if random.choice([True, True, False]):  # 66% elegible
            ...
            return {
                "eligible": False,
                "reason": "Plazo de devolución expirado (30 días)"
            }
