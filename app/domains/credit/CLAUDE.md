# CLAUDE.md - Credit Domain

Guidance for Claude Code working with the Credit domain.

## Domain Overview

**Credit Domain** - Finance and credit operations management within Aynux multi-domain platform.
