"""
Category database query tool for E-commerce domain agents.
"""
...
class CategoryTool:
        ...
        try:
            async with get_async_db_context() as db:
                ...
                query = (
                    ...
                    .outerjoin(Product, (Category.id == Product.category_id) & Product.active.is_(True))
    ...
    async def get_category_by_name(self, category_name: str) -> dict[str, Any] | None:
        """
