# CLAUDE.md - E-commerce Domain

Guidance for Claude Code working with the E-commerce domain.

## Domain Overview

**E-commerce Domain** - Online commerce operations within Aynux multi-domain platform.
