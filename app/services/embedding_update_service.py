...
from app.models.database import Product, Category, Subcategory, Brand, Promotion
...
class EmbeddingUpdateService:
    ...
    def _create_product_document(self, product: Product, category: str, subcategory: Optional[str], brand: str, promotions: List[Promotion]) -> Document:
        ...
        content_parts.extend([
            f"Precio: ${product.current_price}",
            ...
            try:
                ...
                for product in products:
                    ...
                    for collection in self.category_collections.values():
                        collection.delete(where={"product_id": product.id})
